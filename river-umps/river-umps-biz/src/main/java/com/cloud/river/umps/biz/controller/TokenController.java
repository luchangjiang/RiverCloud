...
import com.cloud.river.umps.api.feign.RemoteTokenService;
...
public class TokenController {
    ...
    public R getPage(@RequestParam Map<String, Object> params){
        return new R<>(remoteTokenService.getTokenPage(params, SecurityConstants.FROM_IN));
    }
    ...
    public R removeToken(String token){
        return new R<>(remoteTokenService.removeTokenById(token, SecurityConstants.FROM_IN));
    }
}
