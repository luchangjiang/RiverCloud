...
import com.cloud.river.upms.biz.mapper.SysSocialDetailsMapper;
import com.cloud.river.upms.biz.service.SysSocialDetailsService;
...
public class WeChatLoginHandler extends AbstractLoginHandler{
    ...
    public String identify(String code){
        SysSocialDetails sysSocialDetails = sysSocialDetailsMapper.selectOne(Wrappers.<SysSocialDetails>query().lambda()
